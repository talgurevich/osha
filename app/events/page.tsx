        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gradient-to-br from-osha-green/10 to-osha-gold/10 p-8 md:p-12 rounded-3xl shadow-lg">
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                ערב תרבות, טעימות־קפה, פיצות נפוליטניות תחת כיפת השמיים – כי החוויה מתחילה כאן. אירועים שמשלבים אוכל מעולה, אווירה ייחודית ותוכן איכותי.
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">
                  נתאים תפריט וסגנון שמתאים בדיוק לכם - קוקטיילים, בר בירה, פיצות ועוד.
                </p>
              </div>
            </div>

...
export default function Reviews() {
  const reviews = [
    ...
    {
      name: "דנה",
      text: "אני מאוד ממליצה על עגלת קפה אוֹשָׁה. גיא, הבעלים של המקום הוא אדם מקסים ואדיב, אוכל מגוון ומעולה, מקום יפה, אווירה נעימה. הייתי שם באירוע חברה בארוחת בראנץ' והיה מושלם!!",
      date: "לפני חודש"
    }
  ];
